...
const g2={};
new Function('g','with(g){'+readFileSync(join(root,'js/data.js'),'utf8')+
  ';Object.assign(g,{P,LEGS,DAYS,POIS,WAYPTS,BOOKINGS,RISERVATI_EXTRA})}')(g2);

/* L'elenco di ciò che non deve uscire si ricava qui dai dati privati.
   In js/sanifica.js, che è pubblico, non c'è nessun segreto scritto. */
const ris=Sanifica.riservatiDa(g2.BOOKINGS,g2.LEGS,g2.DAYS,g2.RISERVATI_EXTRA);
if(!ris.nomi.length){ console.error('FERMO: non ho ricavato nessun nome da proteggere.'); process.exit(1); }
const esito=Sanifica.genera(g2.P,g2.LEGS,g2.DAYS,g2.POIS,g2.WAYPTS,ris);
