/* ═══════════════════════════════════════════════════════════
   ...
   - meteo, cambi, Wikipedia, rotte: prima la rete, poi la
     cache come riserva
   ═══════════════════════════════════════════════════════════ */
const SHELL='orbit-shell-v16', TILES='orbit-tiles', DATA='orbit-data';
const PRECACHE=['./','./index.html','./manifest.webmanifest','./icon.png',
 ...
 './js/media.js','./js/sanifica.js','./js/pubblica.js','./js/dati.js','./js/docs.js','./js/ornaments.js','./js/cinematic.js','./js/main.js','./js/boot.js',
